...
lint-py:  ## lint python with ruff
	python -m ruff check airflow_nomad
	python -m ruff format --check airflow_nomad
...
fix-py:  ## autoformat python code with ruff
	python -m ruff check --fix airflow_nomad
	python -m ruff format airflow_nomad
...
test:  ## run python tests
	python -m pytest -v airflow_nomad/tests

coverage:  ## run tests and collect test coverage
	python -m pytest -v airflow_nomad/tests --cov=airflow_nomad --cov-report term-missing --cov-report xml
